...
import type {
    ReverseOptionLP,
    ReverseOptionLPInterface,
} from '../ReverseOptionLP'
        ...
        outputs: [
            {
                ...
                internalType: 'struct ReverseOptionLP.LpPosition[]',
                name: '',
                type: 'tuple[]',
            },
        ],
...
export class ReverseOptionLP__factory {
    static readonly abi = _abi
    static createInterface(): ReverseOptionLPInterface {
        return new utils.Interface(_abi) as ReverseOptionLPInterface
    }
    static connect(
        address: string,
        signerOrProvider: Signer | Provider
    ): ReverseOptionLP {
        return new Contract(address, _abi, signerOrProvider) as ReverseOptionLP
    }
}
