...
export interface SsovV4PutInterface extends utils.Interface {
    ...
    getEvent(
        nameOrSignatureOrTopic: 'ExpireDelayToleranceUpdate'
    ): EventFragment
...
export interface SsovV4Put extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: SsovV4PutInterface
    ...
    functions: {
        ...
        getEpochTimes(
            ...
            [BigNumber, BigNumber] & { start: BigNumber; end: BigNumber }
        >
